...
from module import *
from ui import Ui_fileencoder


class Encoder(QMainWindow, Ui_fileencoder):
    def __init__(self):
        ...
        self.encode_Button.clicked.connect(self.encode_programer)
    ...
    def encode_programer(self):
        if self.inputfile is not None and self.outputflod is not None:
            ...
            QMessageBox.about(self, "消息提示", "编码完成")
        else:
